...
{
	internal class ParallelAsyncRunner<T>
	{
	...
	internal record ParallelResult<T>(IEnumerable<Exception>? Exceptions, IEnumerable<T> Results);

	internal class ParallelAsyncRunner<TIn, TOut>
	{
