...
const Main = () => (React.createElement("div", { className: "mainContentContainer" },
    ...
    React.createElement("div", { className: "contentContainer" },
        React.createElement("div", { className: "bodyContent" },
            ...
            React.createElement(react_router_1.Route, { path: "/editProfile", render: () => React.createElement(ProfileFull_1.default, null) })),
