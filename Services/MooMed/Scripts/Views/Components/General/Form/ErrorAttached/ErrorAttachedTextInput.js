...
class ErrorAttachedTextInput extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "form-group" },
            React.createElement("input", { className: this._isError() ? "form-control is-invalid" : "form-control", type: this.props.inputType != null ? this.props.inputType : "text", name: this.props.name, value: this.state.payload, onChange: this._handleChange, placeholder: this.props.name, onKeyPress: this._handleKeyPress }),
