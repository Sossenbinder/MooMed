	...
	render() {
        return (
            <div className="signInContainer container">
                ...
                <div>
                    <Switch>
                        <Route exact path="/" render={props => { return <RegisterDialog />}} />
                        <Route exact path="/register" render={props => { return <RegisterDialog /> }} />
                        <Route exact path="/login" render={props => { return <LoginDialog /> }} />
                    </Switch>
                </div>
            </div>
        );
