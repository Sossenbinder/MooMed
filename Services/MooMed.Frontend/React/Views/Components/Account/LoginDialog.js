...
const CheckBoxToggle_1 = require("common/components/General/Input/CheckBoxToggle");
...
exports.LoginDialog = () => {
    ...
    const [rememberMe, setRememberMe] = React.useState({ Value: false, IsValid: true });
    ...
    const handleLogin = () => __awaiter(void 0, void 0, void 0, function* () {
        if (!hasErrors()) {
            ...
            const response = yield request.post(loginModel);
            if (response.success) {
                location.href = "/";
            }
            else {
